...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2).consumes(getConsumeContentTypes())
                ...
                .apis(RequestHandlerSelectors.basePackage("com.happiness")).paths(PathSelectors.ant("/**"))
                .build()
    ...
    private ApiInfo getApiInfo() {
        return new ApiInfoBuilder().title("API").description("[happiness] API").version("1.0").build();
    }
